...
Cache: unified responses are stored in SQLite (`mfapi_cache` table) for `MFAPI_CACHE_TTL_SECONDS` (default 21600 = 6 hours). Optional: `MFAPI_BASE_URL`, `CAPTNEMO_BASE_URL` (defaults shown in the links above).
